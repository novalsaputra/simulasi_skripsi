...
b = DeltaTrimax(D)
gb,kb,wb, msrb = b.fit(db,1.25,n_triclusters=0)

np.savetxt("gen12.txt",gb,fmt="%0.f")
np.savetxt("kondisi12.txt",kb,fmt="%0.f")
np.savetxt("waktu12.txt",wb,fmt="%0.f")
np.savetxt("msr12.txt",msrb)
