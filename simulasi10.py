...
a = DeltaTrimax(D)
ga,ka,wa, msra = a.fit(da,1.15,n_triclusters=0)

np.savetxt("gen10.txt",ga,fmt="%0.f")
np.savetxt("kondisi10.txt",ka,fmt="%0.f")
np.savetxt("waktu10.txt",wa,fmt="%0.f")
np.savetxt("msr10.txt",msra)
